...
"""autogenerated by genpy from rtabmap_ros/RGBDImages.msg. Do not edit."""
import sys
...
uint8[] data"""
  ...
  _slot_types = ['std_msgs/Header','rtabmap_ros/RGBDImage[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.rgbd_images:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v3.D))
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v7.D))
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_i().pack(_v24.type))
        _x = _v24.info
        length = len(_x)
        # - if encoded as a list instead, serialize as bytes instead of string
        if type(_x) in [list, tuple]:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rtabmap_ros.msg.RGBDImage()
        _v27 = val1.header
        start = end
        end += 4
        ...
        if python3:
          _v29.distortion_model = str[start:end].decode('utf-8')
        else:
        ...
        _v29.D = struct.unpack(pattern, str[start:end])
        start = end
        end += 72
        ...
        _v33.D = struct.unpack(pattern, str[start:end])
        start = end
        end += 72
        ...
        if python3:
          _v43.format = str[start:end].decode('utf-8')
        else:
    ...
    try:
      ...
      for val1 in self.rgbd_images:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_i().pack(_v76.type))
        _x = _v76.info
        length = len(_x)
        # - if encoded as a list instead, serialize as bytes instead of string
        if type(_x) in [list, tuple]:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v81.distortion_model = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v85.distortion_model = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v95.format = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v98.format = str[start:end].decode('utf-8')
        else:
